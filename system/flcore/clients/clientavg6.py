...
class clientAVG(Client):
    ...
    def D_train(self, x):
        ...
        # D_loss = D_loss + l2_lambda * sum(torch.linalg.norm(p.flatten(), 2)
        #                                   ** 2 for p in self.model_D.parameters())
        D_loss = D_loss + \
    ...
    def G_train(self, x):
        ...
        # G_loss = G_loss + l2_lambda * sum(torch.linalg.norm(p.flatten(), 2)
        #                                   ** 2 for p in self.model_G.parameters())
