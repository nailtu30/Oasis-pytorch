import time
from flcore.clients.clientavg_dcgan_cifar10 import clientAVG
...
class FedAvgDCGANCifar10(Server):
    def __init__(self, args, times):
        ...
        print(
            f"\nJoin ratio / total clients: {self.join_clients} / {self.num_clients}")
